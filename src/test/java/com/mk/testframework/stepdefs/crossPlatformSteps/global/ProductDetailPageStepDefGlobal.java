...
public class ProductDetailPageStepDefGlobal {
    ...
    @Inject
    public ProductDetailPageStepDefGlobal(MkProductDetailPageEU mkProductDetailpageEU, PageUtils pageUtils, MkProductContainer mkProductContainer) {
