...
public class ProductListingPageStepDefEU {
	...
	@Inject
	public ProductListingPageStepDefEU(WebDriver webDriver, MkProductListing mkProductListing) {
	...
	public void i_verify_product_image_changed_clicking_swatches_plp() {
		Assert.assertTrue("clicking on Color Swatches not changes product image",
				mkProductListing.isColorSwatchDisplayedOnPLPAndClickable());
	}
